MQTT Dataset v1.2
Evaluating the Reliability of MQTT with Comparative Analysis
...
This dataset was introduced in this peer-reviewed publication:
...
Please cite the above paper if using the dataset. For any questions, please contact: uwtinres@gmail.com
